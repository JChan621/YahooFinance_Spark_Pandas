...
def retrieve_ticker_history(ticker : str):
    ...
    url = 'https://query1.finance.yahoo.com/v8/finance/chart/' + ticker.upper() + '?formatted=true&crumb=FIOmmg93x1j&lang=en-US&region=US&includeAdjustedClose=true&interval=1d&period1=916963200&period2=' + curr_time + '&events=capitalGain%7Cdiv%7Csplit&useYfid=true&corsDomain=finance.yahoo.com'
    ...
    ticker_df.drop(ticker.df.tail(1).index,inplace=True)
